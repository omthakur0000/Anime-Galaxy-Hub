...
if (isset($getEpisode['error'])) {
    header('Location: https://aniwatchtv.xyz/home');
}
;
...
if (empty($counter)) {
    $counter = 1;
    mysqli_query($conn, "INSERT INTO `pageview` (pageID,totalview,like_count,dislike_count,animeID) VALUES('$pageID','$counter','36492','3481','$animeID')");
...
$download1 = str_replace("Gogoanime", "$websiteTitle", $getEpisode);
...
$like_count = $rows['like_count'] + 16;
mysqli_query($conn, "UPDATE `pageview` SET like_count ='$like_count' WHERE pageID = '$pageID'");
$dislike_count = $rows['dislike_count'] + 5;
mysqli_query($conn, "UPDATE `pageview` SET dislike_count ='$dislike_count' WHERE pageID = '$pageID'");
                                            ...
                                            <div class="ps__-list">
                                                <div class="item">
                                                    <a id="server1" href="https://player.ryuk.to?id=<?= $url ?>"
                                                        target="iframe-to-load" class="btn btn-server active">NO ADS</a>
                                                </div>
                                                <div class="item">
                                                    <a id="server2"
                                                        href="https://player.anixtv.in/player/player1.php?id=<?=$url?>&download=<?=$anime['ep_download']?>"
                                                        target="iframe-to-load" class="btn btn-server">NO ADS 2</a>
                                                </div>
                                                <div class="item">
                                                    <a id="server2"
                                                        href="https://player.anixtv.in/player/player2.php?id=<?=$url?>"
                                                        target="iframe-to-load" class="btn btn-server">NO ADS 3</a>
                                                </div>
                                                <div class="item">
                                                    <a id="server2"
                                                        href="<?= $getEpisode['video'] ?>"
                                                        target="iframe-to-load" class="btn btn-server">Vidstreaming</a>
                                                </div>
                                                 <div class="item">
                                                    <a id="server3"
                                                        href="<?= $getEpisode['gogoserver'] ?>"
                                                        target="iframe-to-load" class="btn btn-server">Gogo Server</a>
                                                </div>

...
<head>
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-DDV0GSFGHG"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-DDV0GSFGHG');
</script>
                            ...
                            <div class="anisc-info-wrap">
                                <div class="anisc-info">
                                    ...
                                    <div class="item item-title">
                                        <span class="item-head">Name:</span> <span class="name"><?=$getAnime['name']?></span>
                                    </div>
                                    <div class="item item-title">
                                    ...
                                    <div class="item item-title">
                                        <span class="item-head">Release Year:</span> <span class="name"><?=$getAnime['']?></span>
                                    </div>
                                    <div class="item item-title">
                                        <span class="item-head">Type:</span> <span class="name"><?=$getAnime['type']?></span>
                                    </div>
                                    <div class="item item-title">
                                        <span class="item-head"> <a href="<?php if ($getAnime['othername'] == "Completed") {echo "/status/completed";} else {echo "/status/ongoing";}?>"><?=$getAnime['othername']?></a> </span>
                                    </div>
                                    <div class="item item-list">
                                        <span class="item-head" class="name"><?=$getAnime['released']?></span>
                                    </div>
